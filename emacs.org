...
- [[#display-time-in-modeline-in-bangla][Display time in modeline in Bangla]]
- [[#battery-status-in-bangla][Battery status in Bangla]]
...
#+END_SRC
* Display time in modeline in Bangla
   #+BEGIN_SRC emacs-lisp
